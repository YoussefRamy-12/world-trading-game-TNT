      ...
      body: RefreshIndicator(
        ...
        child: ListView(padding: const EdgeInsets.all(20), children: [
          Card(child: Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Expanded(child: _Stat(title: 'Countries', value: '${owned.length}', icon: Icons.public)),
              const SizedBox(width: 12),
              Expanded(child: _Stat(title: 'Country value', value: '\$$countryValue', icon: Icons.trending_up)),
              const SizedBox(width: 12),
              Expanded(child: _Stat(title: 'Net worth', value: netWorth == null ? '—' : '\$$netWorth', icon: Icons.account_balance_wallet)),
            ]),
          ]))),
          ...
          for (final country in owned) Card(child: ListTile(
            ...
            subtitle: Text('Country value: ${country.value == null ? '—' : '\$${country.value}'}'),
          )),
        ]),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        const Card(child: Padding(padding: EdgeInsets.all(16), child: Text('Buy countries from other players. Bidding uses the existing marketplace RPCs.'))),
        const SizedBox(height: 12),
